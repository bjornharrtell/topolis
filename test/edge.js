...
describe('edge', () => {
  describe('addIsoEdge', () => {
    ...
    it('should refuse to add a intersecting edge', () => {
      ...
      }).to.throw(/^geometry crosses edge 1$/)
  ...
  describe('addEdgeNewFaces', () => {
    it('should be able to add a closed edge', () => {
      ...
      expect(e2s(edge)).to.equal('1|1|1|1|-1|0|1')
    ...
    it('should be able to add two edges forming a face', () => {
      ...
      expect(e2s(edge1)).to.equal('1|1|2|2|-2|0|1')
      expect(e2s(edge2)).to.equal('2|2|1|1|-1|0|1')
    ...
    it('should be able to add three edges forming two faces', () => {
      ...
      expect(e2s(edge1)).to.equal('1|1|2|2|3|0|3')
      expect(e2s(edge2)).to.equal('2|2|1|1|-3|0|2')
      expect(e2s(edge3)).to.equal('3|1|2|-1|-2|3|2')
    ...
    it('should be able to add six edges forming three faces', () => {
      ...
      expect(e2s(edge1)).to.equal('1|1|2|2|6|0|5')
      expect(e2s(edge2)).to.equal('2|2|3|3|-6|0|4')
      expect(e2s(edge3)).to.equal('3|3|4|4|-5|0|2')
      expect(e2s(edge4)).to.equal('4|4|1|1|-3|0|2')
      expect(e2s(edge5)).to.equal('5|1|3|-2|-4|4|2')
      expect(e2s(edge6)).to.equal('6|1|2|-1|5|5|4')
    ...
    it('should be able to add two edges forming two faces', () => {
      ...
      expect(e2s(edge1)).to.equal('1|1|1|2|-1|0|1')
      expect(e2s(edge2)).to.equal('2|1|1|1|-2|0|2')
  ...
  describe('modEdgeSplit', () => {
    it('should split a middle edge into two edges', () => {
      ...
      expect(e2s(edge1)).to.equal('1|1|2|2|3|0|3')
      expect(e2s(edge2)).to.equal('2|2|1|1|-4|0|2')
      expect(e2s(edge3)).to.equal('3|1|3|4|-2|3|2')
      expect(e2s(edge4)).to.equal('4|3|2|-1|-3|3|2')
  ...
  describe('modEdgeSplit', () => {
    it('should split two edges and one face into five edges and two faces', () => {
      ...
      expect(e2s(edge1)).to.equal('1|1|3|3|-4|0|2')
      expect(e2s(edge2)).to.equal('2|2|4|4|-3|0|3')
      expect(e2s(edge3)).to.equal('3|3|2|2|5|0|3')
      expect(e2s(edge4)).to.equal('4|4|1|1|-5|0|2')
      expect(e2s(edge5)).to.equal('5|3|4|-2|-1|3|2')
  ...
  describe('remEdgeNewFaces', () => {
    it('should be able to remove a single edge/face', () => {
      ...
      expect(e2s(edge)).to.equal('1|1|1|1|-1|0|0')
    })
    ...
    it('should be able to remove a single edge and merge tree faces into two', () => {
      ...
      expect(e2s(edge1)).to.equal('1|1|2|2|-2|0|4')
      expect(e2s(edge2)).to.equal('2|2|1|1|-1|0|4')
    ...
    it('should be able to ...', () => {
      ...
      expect(e2s(edge1)).to.equal('1|1|3|3|-4|0|4')
      expect(e2s(edge2)).to.equal('2|2|4|4|-3|0|4')
      expect(e2s(edge3)).to.equal('3|3|2|2|-1|0|4')
      expect(e2s(edge4)).to.equal('4|4|1|1|-2|0|4')

      const node5 = topo.modEdgeSplit(edge1, [0, 1])
      const edge6 = edge1.nextLeft

      expect(e2s(edge1)).to.equal('1|1|5|6|-4|0|4')
      expect(e2s(edge2)).to.equal('2|2|4|4|-3|0|4')
      ...
      expect(e2s(edge1)).to.equal('1|1|5|6|-4|0|4')
      expect(e2s(edge2)).to.equal('2|2|6|7|-3|0|4')

      const edge8 = topo.addEdgeNewFaces(node5, node6, [[0, 1], [1, 0]])

      expect(e2s(edge1)).to.equal('1|1|5|6|-4|0|5')
      expect(e2s(edge2)).to.equal('2|2|6|7|-3|0|6')
      expect(e2s(edge3)).to.equal('3|3|2|2|-6|0|6')
      expect(e2s(edge4)).to.equal('4|4|1|1|-7|0|5')
      expect(e2s(edge6)).to.equal('6|5|3|3|8|0|6')
      expect(e2s(edge7)).to.equal('7|6|4|4|-8|0|5')
      expect(e2s(edge8)).to.equal('8|5|6|-2|-1|6|5')
